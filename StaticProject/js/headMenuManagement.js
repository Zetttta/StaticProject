...
$(function() {
    ...
    $('.menuRange').hover(function() {
        ...
        $("#headMenuManagement").animate({'top':'50px'},200);
        $("#headMenuLogout").animate({'top':'75px'},200);
    // マウスが離れた時の処理
    }, function() {
        // メニューを格納
    ...
    // 管理者用画面
    $('#headMenuManagement').hover(function() {
        // 色を変更
        $("#headMenuManagement").css('background', '#8DC1DD');
    // マウスが離れた時の処理
    }, function() {
        // 色を戻す
        $("#headMenuManagement").css('background', '');
    });
    // ログアウト
